...
public class UserMLFragment extends Fragment {
	private static final String TAG = UserMLFragment.class.getSimpleName();
	...
	public UserPCRecyclerView adapter;
	...
	public static UserMLFragment newInstance(int pos) {
		UserMLFragment fragment = new UserMLFragment();
		Bundle b = new Bundle();
		b.putInt(KEY_POSITION, pos);
		fragment.setArguments(b);

		UserMLFragment.POSITION = pos;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		API_NEWS_FEED = 
				"{\"by\": {\"user_id\": \"" + UserInfoFActivity.KEY_GET_USER_ID 
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
	    ...
	    adapter = new UserPCRecyclerView(getActivity(), AvailList);
