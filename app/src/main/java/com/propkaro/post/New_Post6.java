...
public class New_Post6 extends Fragment implements OnItemSelectedListener{

	static String TAG = New_Post6.class.getSimpleName();
	...
	String getUserDataID = "", getUserType = "";
	...
	long getAbsolut_prce , getAbsolut_prce1, getAbsolut_prce2,
	getAbsolut_prce3;
...
//				// ////////////////////////////////////////////////////////
	    btn_airport = (ImageButton)rView.findViewById(R.id.btn_airport);
	    btn_airport.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				if(i == 0){
					...
					i = 1;
					amenties.append(0, false);
				}else{
					btn_airport.setBackgroundResource(R.mipmap.airport_selected);
					i = 0;
					amenties.append(0, true);
				}
			}
		});
	    
	    
	    btn_bus = (ImageButton)rView.findViewById(R.id.btn_bus);
	    btn_bus.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				if(j == 0){
					...
					j = 1;
					amenties.append(1, false);
				}else{
					btn_bus.setBackgroundResource(R.mipmap.bus_selected);
					j = 0;
					amenties.append(1, true);
				}
			}
		});
	     btn_gym = (ImageButton)rView.findViewById(R.id.btn_gym);
	    btn_gym.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				if(k == 0){
					...
					k = 1;
					amenties.append(2, false);
				}else{
					btn_gym.setBackgroundResource(R.mipmap.gym_selected);
					k = 0;
					amenties.append(2, true);
				}
			}
		});
	    
	    btn_hospital = (ImageButton)rView.findViewById(R.id.btn_hospital);
	    btn_hospital.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				if(l == 0){
					...
					l = 1;
					amenties.append(3, false);
				}else{
					btn_hospital.setBackgroundResource(R.mipmap.hospital_selected);
					l = 0;
						amenties.append(3, true);
				}
			}
		});
	    
	     btn_internet = (ImageButton)rView.findViewById(R.id.btn_internet);
	    btn_internet.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				if(m == 0){
					...
					m = 1;
					amenties.append(4, false);
				}else{
					btn_internet.setBackgroundResource(R.mipmap.internet_selected);
					m = 0;
						amenties.append(4, true);
				}
			}
		});
	    
	    btn_market = (ImageButton)rView.findViewById(R.id.btn_market);
	    btn_market.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				if(n == 0){
					...
					n = 1;
					amenties.append(5, false);
				}else{
					btn_market.setBackgroundResource(R.mipmap.market_selected);
					n = 0;
					amenties.append(5, true);
				}
			}
		});
	    
	     btn_park = (ImageButton)rView.findViewById(R.id.btn_park);
	    btn_park.setOnClickListener(new OnClickListener() {
			
			@Override
			public void onClick(View arg0) {
				if(o == 0){
					btn_park.setActivated(false);
					btn_park.setBackgroundResource(R.mipmap.park_unselected);
					o = 1;
					amenties.append(6, false);
				}else{
					btn_park.setActivated(true);
					btn_park.setBackgroundResource(R.mipmap.park_selected);
						o = 0;
						amenties.append(6, true);
				}
			}
		});
	    
	     btn_railway_stn = (ImageButton)rView.findViewById(R.id.btn_railway_stn);
	    btn_railway_stn.setOnClickListener(new OnClickListener() {
			
			@Override
			public void onClick(View arg0) {
				if(p == 0){
					btn_railway_stn.setActivated(false);
					btn_railway_stn.setBackgroundResource(R.mipmap.rail_unselected);
					p = 1;
					amenties.append(7, false);
				}else{
					btn_railway_stn.setActivated(true);
					btn_railway_stn.setBackgroundResource(R.mipmap.rail_selected);
						p = 0;
						amenties.append(7, true);
				}
			}
		});
	    
	     btn_school = (ImageButton)rView.findViewById(R.id.btn_school);
	    btn_school.setOnClickListener(new OnClickListener() {
			
			@Override
			public void onClick(View arg0) {
				if(q == 0){
					btn_school.setActivated(false);
					btn_school.setBackgroundResource(R.mipmap.school_unselected);
					q = 1;
					amenties.append(8, false);
//					temp_school = "";
				}else{
					btn_school.setActivated(true);
					btn_school.setBackgroundResource(R.mipmap.school_selected);
						q = 0;
						amenties.append(8, true);
//						temp_school = "school";
				}
			}
		});
//	    getAmenities = temp_school + ", " +;
	    // FIXME: HANDLE AMENITIES HERE HARI-------------------------------------
...
//-----------------------------------FIXME: END AMENITIES.-------------------------	    	
		...
		add_price_unitAdapter.setDropDownViewResource(android.R.layout.simple_dropdown_item_1line);
		...
		freqAdapter.setDropDownViewResource(android.R.layout.simple_dropdown_item_1line);
		...
		btn_finish.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				EditText et_mntnce_charge = (EditText) rView.findViewById(R.id.et_mntnce_charge);
...
//							}
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// -----------get post 2 data
		getSuper_Area = b.getString("KEY_getSuper_Area");
		getPlot_Area = b.getString("KEY_getPlot_Area");
		getCarpet_Area = b.getString("KEY_getCarpet_Area");
		...
		get_Transaction_type = b.getString("KEY_get_Transaction_type");
		getProp_availblty = b.getString("KEY_getProp_availblty" );
		getProp_ownership = b.getString("KEY_getProp_ownership");
	...
	public void openDialog(Context ctx) {
		...
		// getUserId = getLongent().getExtras().getString("KEY_USER_ID");
		// tv_user_id = (TextView)findViewById(R.id.tv_user_id);

//		btn_EDIT = (Button) customdialog.findViewById(R.id.btn_EDIT);
		...
		if (parent.getId() == R.id.spin_freq) {
			...
			for (int i = 0; i < str_spn_freq.length; i++) {
				if (temp_get_freq.equals(str_spn_freq[i])) {
					freq.setSelection(i);
					if(Utilities.D)Log.v(TAG,"freq" + str_spn_freq[i]);
...
//			if (getPropertyType.contains("Studio Apartment")) {
//				Log.d("TAG", "getRent_purchase===" + "studio wala");
...
//
//				lnr_avl_furn.setVisibility(View.VISIBLE);
//				lnr_sbmt.setVisibility(View.VISIBLE);
//				lnr_trans_poss.setVisibility(View.VISIBLE);
//
//				lnr_spin1.setVisibility(View.VISIBLE);
//				lnr_spin2.setVisibility(View.VISIBLE);
//				lnr_spin3.setVisibility(View.VISIBLE);
//			}
//		}
	...
	protected String checkTransaction(String str){
	...
	class PostPropertyTask extends AsyncTask<String, String, String> {
		int api_code = 0;
		public String api_message = "", userId = "", userName = "", api_data;
		Dialog dialog;
...
//									getProjectName
									...
									+ "\"}";
				String str_send_json = "{\"table\":\"properties\", \"params\":"
						+ POST_PROPERTY_USER + "}";
				...
				if (api_code == 200) {
					...
					getPropertyID = api_data;
					if(Utilities.D)Log.v(TAG,"api_data=" + api_data);
...
//				int nh = (int) ( bm.getHeight() * (200.0 / bm.getWidth()) );
	...
	private class UploadPicTask extends AsyncTask<Bitmap, Void, Void> {
		...
		protected void onPostExecute(Void result) {
			...
			new AddTriggerRequirementTask().execute(getPropertyID);
		}
	}
	class AddTriggerRequirementTask extends AsyncTask<String, String, String> {
			...
			dialog.setOnKeyListener(new DialogInterface.OnKeyListener() {
				...
				public boolean onKey(DialogInterface arg0, int keyCode, KeyEvent arg2) {
					if (keyCode == KeyEvent.KEYCODE_BACK) {
						...
						AddTriggerRequirementTask.this.cancel(true);
						dialog.dismiss();
						if(Utilities.D)Log.v(TAG,"Dialog cancelled on KEYCODE_BACK");
					}
					return false;
		...
		@Override
		protected String doInBackground(String... f_url) {
			if(Utilities.D)Log.v(TAG,"doInBackground=======TriggerTask");
			try {
				String ExtraUrlHit = "https://www.propkaro.com:3000/requirement/"
						+ f_url[0]
						+ "/" + GridActivity.getFName.replaceAll(" ", "%20") + ""
//						+ "/" + GridActivity.getLName.replaceAll(" ", "%20") + "%20"
						+ "/" + getUserDataID 
						+ "/" + getCity.replaceAll(" ", "%20");
		...
		protected void onPostExecute(String file_url) {
			...
			//FIXME: ACTIVITY_TASK ADD HERE........
			new AddActivityTask().execute("");
		}
	}
	private class AddActivityTask extends AsyncTask<String, String, String> {
		...
		protected String doInBackground(String... f_url) {
			...
			Date date = new Date();
			String timeString = new Timestamp(date.getTime()).toString();
			String ADD_ACTIVITY = "{\"table\":\"activities\",\"params\":{\"activity_type_id\":\"1\",\"event_id\":\"" 
					+ getPropertyID + "\",\"posted_by\":\"" 
					+ getUserDataID + "\",\"activity_datetime\":\"" 
					+ timeString + "\",\"content\":\"Posted A Property\"}}";
			String urlBase = Host.PostUrl;

			Utilities.sendData(urlBase, ADD_ACTIVITY);
		...
		protected void onPostExecute(String result) {
			super.onPostExecute(result);
			if(Utilities.D)Log.v(TAG,"onPostExecute(): Activity added to Timeline !");
			getActivity().finish();
