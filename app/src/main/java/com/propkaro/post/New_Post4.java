...
public class New_Post4 extends Fragment implements OnItemSelectedListener{

	static String TAG = New_Post4.class.getSimpleName();
...
//			getProjectName = "",
	...
	String temp_getfloorbldng = "0", temp_city = "0", temp_getBedrooms = "0",  temp_getBathrooms = "0", 
...
//	GoogleMap googleMap;
	...
	EditText mSearchEdiText, et_location;
	ListView mListView;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		back0.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				editor.putString("PREF_KEY_Location_type",btn_location.getText().toString()+ "");
...
//				args.putString("KEY_ProjectName_type", getProjectName);
		...
		if(getPropertyType.contains("Residential")){
						Log.d(TAG, "rb_For_Residential===" + getPropertyType);

						ArrayAdapter<String> resdAdapter = new ArrayAdapter<String>(getActivity(),
								android.R.layout.simple_spinner_item,spin_prop_type1);

						resdAdapter.setDropDownViewResource(android.R.layout.simple_list_item_checked);
		...
		if(getPropertyType.contains("Commercial")){
						...
						ArrayAdapter<String> commAdapter = new ArrayAdapter<String>(getActivity(),
								android.R.layout.simple_spinner_item,spin_prop_type2);
...
//		spin_prop_type1.setTypeface(RobotoLight);
	...
	public void flipCard() {
		...
		mHandler.post(new Runnable() {
			...
			public void run() {
				...
				try {
					Utilities.addFragment(getActivity(), new New_Post5(), R.id.container, true, true);
	...
	public void openCityDialog(View v, final View v2) {
		...
		mSearchEdiText = (EditText) dialog.findViewById(R.id.ListSearch);
...
//		imm.toggleSoftInput(InputMethodManager.SHOW_FORCED, InputMethodManager.HIDE_IMPLICIT_ONLY);
		atv_location.addTextChangedListener(new TextWatcher() {
			...
			public void onTextChanged(CharSequence arg0, int arg1, int arg2, int arg3) {
				...
				String mapUrl = Host.AutoCompleteUrl + "input=" 
				+ getLocation.replaceAll(" ", "%20").replaceAll("\\s+", "+")
