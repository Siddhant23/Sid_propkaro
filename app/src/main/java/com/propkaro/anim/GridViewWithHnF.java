 ...
 * See {@link GridViewWithHnF#addHeaderView(View, Object, boolean)}
 * See {@link GridViewWithHnF#addFooterView(View, Object, boolean)}
 */
public class GridViewWithHnF extends GridView {
    ...
    public GridViewWithHnF(Context context) {
        super(context);
        initHeaderGridView();
    }

    public GridViewWithHnF(Context context, AttributeSet attrs) {
        super(context, attrs);
        initHeaderGridView();
    }

    public GridViewWithHnF(Context context, AttributeSet attrs, int defStyle) {
    ...
    private class FullWidthFixedViewLayout extends FrameLayout {
        ...
        @Override
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            int targetWidth = GridViewWithHnF.this.getMeasuredWidth()
                    - GridViewWithHnF.this.getPaddingLeft()
                    - GridViewWithHnF.this.getPaddingRight();
