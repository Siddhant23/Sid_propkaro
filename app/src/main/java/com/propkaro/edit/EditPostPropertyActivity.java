...
import com.propkaro.post.edit.*;
import com.propkaro.util.Utilities;

public class EditPostPropertyActivity extends AppCompatActivity {
	private static final String TAG = EditPostPropertyActivity.class.getSimpleName();
...
//        activity.mToolbar.setNavigationIcon(R.drawable.back);
        ...
        getSupportActionBar().setTitle("Edit Post Listing");
	...
	public void flipCard() {
		...
		mHandler.post(new Runnable() {
			...
			public void run() {
				...
				try {
					Utilities.replaceFragment(fActivity, new com.propkaro.post.edit.Edit_New_Post4(), R.id.container, false, true);
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		...
		if (keyCode == KeyEvent.KEYCODE_BACK) {
			...
			Utilities.showAlertFinish(fActivity, "Alert", "Are you sure to cancel post ?", true);
			return true;
		}
