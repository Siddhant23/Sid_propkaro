...
public class AvailPCSetter {
	private String tv_title = "", thumbnailUrl, imageUrl, 
			tv_location, tv_area, tv_rate, tv_postedBy, tv_userType, 
...
//	private ArrayList<String> genre;
	...
	public AvailPCSetter(
			...
			boolean isShortlisted, boolean isBoolEnable, String broker_revenue) {
		...
		this.broker_revenue = broker_revenue;
	}
	...
	public boolean equals(Object obj) {
		...
		AvailPCSetter other = (AvailPCSetter) obj;
	...
	public String getBroker_revenue() {
		return broker_revenue;
	}

	public void setBroker_revenue(String broker_revenue) {
		this.broker_revenue = broker_revenue;
	}
