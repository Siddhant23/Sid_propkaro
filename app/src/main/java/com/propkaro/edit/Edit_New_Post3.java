...
import com.propkaro.post.edit.Edit_New_Post4;
import com.propkaro.util.Utilities;

public class Edit_New_Post3 extends Fragment implements OnTouchListener,OnItemSelectedListener{

	static String TAG = Edit_New_Post3.class.getSimpleName();
...
//			getProjectName = "",
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		TextView tv_from_step2= (TextView) rView.findViewById(R.id.tv_from_step2);
	...
	public void flipCard() {
		...
		mHandler.post(new Runnable() {
			...
			public void run() {
				...
				try {
					Utilities.addFragment(getActivity(), new Edit_New_Post4(), R.id.container, true, true);
