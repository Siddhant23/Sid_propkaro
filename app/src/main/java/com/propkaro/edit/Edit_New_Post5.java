...
import com.propkaro.post.edit.Edit_New_Post6;
import com.propkaro.util.Host;
import com.propkaro.util.Utilities;

public class Edit_New_Post5 extends Fragment implements OnItemSelectedListener{

	static String TAG = Edit_New_Post5.class.getSimpleName();
	String getBedrooms = "", getBathrooms = "", getBalconies = "",
			...
			getFreq = "";
	String temp_getBedrooms = "", temp_getBathrooms = "",temp_getAbsolute_price = "",
			temp_getBalconies = "", temp_getWashrooms = "",temp_get_Descrption="",
			temp_getAdd_prce = "", temp_getfloorbldng = "",
			temp_getTotal_floor_bldng = "", temp_getSuper_Area = "",
			temp_getPlot_Area = "", temp_getCarpet_Area = "",
			temp_getSuper_Unit_Area = "", temp_getCarpet_Unit_Area = "",
			temp_getPlot_Unit_Area = "", temp_getCrore = "",
			temp_get_thousand = "", temp_get_lakh = "", temp_get_freq = "",
			temp_getAdd_prce_area_unit = "",temp_getMntce_chrg="";
	
	TextView prop_username, prop_date, prop_city, prop_description, prop_price,
			prop_area,tv_absolute_prce, tv_from_step4, tv_1, tv_2, tv_step5;
	...
	long getCalculateArea = 0,getCalculateArea1=0;
...
/////////////////////////////////////////////////////////////////////
		...
		if(getBathrooms.contains(" -- ")){
			et_bathrooms.setText("");
		}else { 
		...
		tv_absolute_prce.setText(Host.rupeeFormat(getAbsolut_prce + ""));
...
//
//		
//		getProp_ownership = mPrefs.getString("PREF_getProp_ownership", "");
...
///////////////////////////////////////////////////////////////////////
				...
				///////////////////////////post 2////////////////////////////
				args.putString("KEY_property_super_area", getSuper_Area);
				args.putString("KEY_property_plot_area", getPlot_Area);
				args.putString("KEY_property_carpet_area", getCarpet_Area);
		...
		//
				...
				args.putString("KEY_Transaction_type", get_Transaction_type);
				args.putString("KEY_Prop_availblty",getProp_availblty );
				args.putString("KEY_Prop_ownership", getProp_ownership);
...
//	
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		getAbsolut_prce = getActivity().getIntent().getLongExtra("KEY_getAbsolut_prce", 0);
		temp_getAbsolute_price = "" + getAbsolut_prce;

		getBedrooms = getActivity().getIntent().getStringExtra("KEY_getBedrooms");
		temp_getBedrooms = getBedrooms;
	
		getBathrooms = getActivity().getIntent().getStringExtra("KEY_getBathrooms");
		temp_getBathrooms = getBathrooms;
		
		getBalconies = getActivity().getIntent().getStringExtra("KEY_getBalconies");
		temp_getBalconies = getBalconies;
		
		getWashrooms = getActivity().getIntent().getStringExtra("KEY_getWashrooms");
		temp_getWashrooms = getWashrooms;
		
		getfloorbldng = getActivity().getIntent().getStringExtra("KEY_getfloorbldng");
		temp_getfloorbldng = getfloorbldng;
		
		getTotal_floor_bldng = getActivity().getIntent().getStringExtra("KEY_getTotal_floor_bldng");
		temp_getTotal_floor_bldng = getTotal_floor_bldng;

		getSuper_Unit_Area = getActivity().getIntent().getStringExtra("KEY_getSuper_Unit_Area");
		temp_getSuper_Unit_Area = getSuper_Unit_Area;
//
		getCarpet_Unit_Area = getActivity().getIntent().getStringExtra("KEY_getCarpet_Unit_Area");
		temp_getCarpet_Unit_Area = getCarpet_Unit_Area;
//
		getPlot_Unit_Area = getActivity().getIntent().getStringExtra("KEY_getPlot_Unit_Area");
		temp_getPlot_Unit_Area = getPlot_Unit_Area;

		getSuper_Area = getActivity().getIntent().getStringExtra("KEY_property_super_area");
		temp_getSuper_Area = getSuper_Area;

		getCarpet_Area = getActivity().getIntent().getStringExtra("KEY_property_carpet_area");
		temp_getCarpet_Area = getCarpet_Area;

		getPlot_Area = getActivity().getIntent().getStringExtra("KEY_property_plot_area");
		temp_getPlot_Area = getPlot_Area;
		
		get_Descrption = getActivity().getIntent().getStringExtra("KEY_property_description");
		temp_get_Descrption = get_Descrption;
		
		getProp_availblty = getActivity().getIntent().getStringExtra("KEY_Prop_availblty");
		temp_getProp_availblty = getProp_availblty;

		getProp_ownership = getActivity().getIntent().getStringExtra("KEY_Prop_ownership");
		temp_getProp_ownership = getProp_ownership;

		get_Transaction_type = getActivity().getIntent().getStringExtra("KEY_Transaction_type");
		temp_get_Transaction_type = get_Transaction_type;
	...
	public void flipCard() {
		...
		mHandler.post(new Runnable() {
			...
			public void run() {
				...
				try {
					Utilities.addFragment(getActivity(), new Edit_New_Post6(), R.id.container, true, true);
...
//	if (getSuper_Area.isEmpty() && (getCarpet_Area.isEmpty())) {
//		// getCalculateArea = Long.parseLong("" + getPlot_Area);
//
//		add_price_unit.setSelection(position);
//	}
