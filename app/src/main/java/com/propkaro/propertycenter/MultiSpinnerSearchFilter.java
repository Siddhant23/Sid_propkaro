...
public class MultiSpinnerSearchFilter extends Spinner implements OnCancelListener {
	...
	public MultiSpinnerSearchFilter(Context context) {
		super(context);
	}

	public MultiSpinnerSearchFilter(Context arg0, AttributeSet arg1) {
		super(arg0, arg1);
	}

	public MultiSpinnerSearchFilter(Context arg0, AttributeSet arg1, int arg2) {
	...
	public void onCancel(DialogInterface dialog) {
		...
		for (int i = 0; i < items.size(); i++) {
			if (items.get(i).getSelected() == true) {
				spinnerBuffer.append(items.get(i).getLocation_city());
		...
		ArrayAdapter<String> adapterSpinner = new ArrayAdapter<String>(getContext(),
				R.layout.multi_spinner_textview_filter,
...
//				items = (ArrayList<KeyPairBoolData>) adapter.arrayList;
	...
	public class MyAdapter extends BaseAdapter implements Filterable {
		...
		public View getView(final int position, View convertView, ViewGroup parent) {
			...
			holder.textView.setText(data.getLocation_city());
				...
				public void onClick(View v)
				{
					...
					for (int i = 0; i < len; i++)
					{
						if (i == position)
						{
							...
							Log.i("TAG", "On Click Selected : " + data.getLocation_city() + " : " + data.getSelected());
							break;
						}
					}
				}
				...
				protected FilterResults performFiltering(CharSequence constraint) {
					...
					if (constraint == null || constraint.length() == 0) {
						...
						for (int i = 0; i < mOriginalValues.size(); i++) {
							Log.i("TAG", "Filter : " + mOriginalValues.get(i).getLocation_city() + " -> " + mOriginalValues.get(i).getSelected());
							String data = mOriginalValues.get(i).getLocation_city();
